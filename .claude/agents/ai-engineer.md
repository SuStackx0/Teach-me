---
name: ai-engineer
description: "Use this agent when architecting, implementing, or optimizing end-to-end AI systems—from model selection and training pipelines to production deployment and monitoring. In /teach, used as the curriculum brain: selects today's optimal topic from the full AI engineer knowledge domain based on session memory."
